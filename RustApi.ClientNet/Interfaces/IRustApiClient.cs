...
namespace RustApi.ClientNet.Interfaces
{
    ...
    public interface IRustApiClient
    {
        ...
        /// <param name="parameters">Request parameters.</param>
        /// <returns></returns>
        Task<TResponse[]> SendCommandAsync<TResponse>(string commandName, Dictionary<string, object> parameters = null);
        ...
        /// <param name="parameters">Request parameters.</param>
        /// <returns></returns>
        Task<TResponse> CallHookAsync<TResponse>(string hookName, Dictionary<string, object> parameters = null);
